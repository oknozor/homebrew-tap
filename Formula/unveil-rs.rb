class UnveilRs < Formula
  desc "A tool to create presentations from markdown inspired by reveal.js, mdbook and zola"
  ...
  if OS.mac?
    url "https://github.com/oknozor/unveil-rs/releases/download/#{version}/unveil-#{version}-x86_64-apple-darwin.tar.gz"
    sha256 "4cbf7bdc4df06bef3e16bafbd15e0fdc25b1c907a5ee4edf37f8d2a8d3d57b24"
  elsif OS.linux?
    if Hardware::CPU.intel?
      url "https://github.com/oknozor/unveil-rs/releases/download/#{version}/unveil-#{version}-x86_64-unknown-linux-gnu.tar.gz"
